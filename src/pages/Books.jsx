    ...
    >
      ...
      >
        ...
        <div className="mt-6 border-t border-primary pt-4">
          ...
          <div className="bg-white border-l-2 border-primary rounded-sm shadow-md p-4 mt-8 w-full lg:w-full">
            ...
            <div className="w-full lg:w-full">
              <div className="border-l-2 p-4 shadow-md border-primary flex flex-col justify-end mb-8 mt-8">
